...
import type { AlgoResultType, ChallengeType } from '@/types/api';
...
const fetchData = async () => {
  ...
  const data_results = (await response_results.json()) as AlgoResultType[];
  const data_challenges = (await response_challenges.json()) as ChallengeType[];
